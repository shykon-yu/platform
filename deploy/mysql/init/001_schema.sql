...
INSERT INTO rooms (code, name, region, hub_name, subnet_cidr, ip_start, ip_end, capacity, sort_order) VALUES
  ...
  ('room-07', '对战房间 07', '主节点', 'we8-room-07', '10.80.7.0/24', '10.80.7.10', '10.80.7.109', 100, 7),
  ('room-08', '对战房间 08', '主节点', 'we8-room-08', '10.80.8.0/24', '10.80.8.10', '10.80.8.109', 100, 8),
  ('room-09', '对战房间 09', '主节点', 'we8-room-09', '10.80.9.0/24', '10.80.9.10', '10.80.9.109', 100, 9),
  ('room-10', '对战房间 10', '主节点', 'we8-room-10', '10.80.10.0/24', '10.80.10.10', '10.80.10.109', 100, 10),
  ('room-11', '对战房间 11', '主节点', 'we8-room-11', '10.80.11.0/24', '10.80.11.10', '10.80.11.109', 100, 11),
  ('room-12', '对战房间 12', '主节点', 'we8-room-12', '10.80.12.0/24', '10.80.12.10', '10.80.12.109', 100, 12);
